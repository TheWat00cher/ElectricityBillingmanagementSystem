...
public class update extends JFrame implements ActionListener {
    ...
    update(String meter)
    {
        ...
        updated.setBackground(Color.black);
        updated.setForeground(Color.white);
        updated.setBounds(70 , 360 , 100 , 20);
        add(updated);
        ...
        cancel.setBounds(230 , 360 , 100 , 20);
        add(cancel);
    ...
    public void actionPerformed(ActionEvent ae)
    {
       if(ae.getSource() == updated)
       {
           ...
           {
             Conn c = new Conn();
             c.s.executeUpdate("update customer set address = '"+address+"' , state = '"+state+"' , city = '"+city+"' , phone_no = '"+phone+"' , email = '"+email+"' where mater_no = '"+meter+"' " );
